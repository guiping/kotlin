...
public interface Errors {
    ...
    DiagnosticFactory4<KtElement, KotlinType, KotlinType, KotlinType, CallableDescriptor> TYPE_MISMATCH_DUE_TO_TYPE_PROJECTIONS = DiagnosticFactory4.create(ERROR);
